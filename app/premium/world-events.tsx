...
export default function WorldEventsScreen() {
  ...
  if (!history) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loaderText}>მსოფლიო არქივი იხსნება...</Text>
      </View>
    );
  }

  const content = history?.world_content;
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      >
        {/* Hero Section - კინემატოგრაფიული ვიზუალი */}
        <View style={styles.heroSection}>
          ...
          <View style={styles.heroTitleContainer}>
            ...
            <Text style={styles.heroLabel}>გლობალური ისტორია</Text>
          </View>
        </View>
        ...
        <View style={styles.contentCard}>
          ...
          <View style={styles.decorativeDivider}>
            ...
            <Ionicons name="globe-outline" size={18} color="rgba(212, 175, 55, 0.5)" style={{ marginHorizontal: 12 }} />
            <View style={styles.line} />
          </View>
          ...
          <View style={styles.footerMotif}>
            ...
            <Text style={styles.footerText}>ისტორია აერთიანებს სამყაროს</Text>
          </View>
        </View>
      </ScrollView>
    </View>
