...
const GALLERY_ITEMS = [
  ...
  },
  {
    ...
    title: "რა მოხდა მედიცინაში",
    subtitle: "მედიცინის მნიშვნელოვანი მოვლენები ამ დღეს",
  },
  {
    image: require("../../assets/gallery/1.webp"),
    title: "ვინ დაიბადნენ და ვინ გარდაიცვალნენ",
    subtitle: "ცნობილი ადამიანები, ბიოგრაფიული ცნობები",
  },
];
...
await refreshHistory();
  ...
  const handleGalleryPress = (index: number) => {
    ...
    if (index === 0) router.push("/premium/georgia-events");
    if (index === 1) router.push("/premium/world-events");
    if (index === 2) router.push("/premium/medicina");
    if (index === 3) router.push("/premium/births");
  };
