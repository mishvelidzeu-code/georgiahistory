...
const styles = StyleSheet.create({
  ...
  codeText:{color:"#000",fontWeight:"700"},
  notFoundBox:{marginTop:40,alignItems:"center"},
  notFoundText:{
    color:"#E5E7EB",
    fontSize:16,
    marginBottom:15,
